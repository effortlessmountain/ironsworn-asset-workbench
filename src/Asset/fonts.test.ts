...
describe("font styles", () => {
    ...
    describe("fontFamily", () => {
        it("returns a well-formed google font URL", () => {
            ...
            const expected = "https://fonts.googleapis.com/css2?family=Indie+Flower&family=Open+Sans+Condensed:ital,wght@1,300&family=Red+Rose:wght@700&family=Simonetta&display=swap"
