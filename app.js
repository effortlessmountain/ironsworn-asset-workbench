    ...
    const createTrackValueHtml = (track, value) => {
        if (value > track) {
            return `<div class="value empty">
                        <svg xmlns='http://www.w3.org/2000/svg' version='1.1' preserveAspectRatio='none' viewBox='0 0 10 10'><line x1='0' y1='10' x2='10' y2='0' stroke='black' vector-effect='non-scaling-stroke' style='stroke:rgb(65,64,66);stroke-width:4' /></svg>
                    </div>`
        } else {
